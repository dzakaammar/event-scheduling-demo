...
type APIClient interface {
	...
	Watch(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (API_WatchClient, error)
}
...
func (c *aPIClient) CreateEvent(ctx context.Context, in *CreateEventRequest, opts ...grpc.CallOption) (*CreateEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.v1.API/CreateEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) UpdateEvent(ctx context.Context, in *UpdateEventRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.v1.API/UpdateEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) DeleteEventByID(ctx context.Context, in *DeleteEventByIDRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/proto.v1.API/DeleteEventByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) FindEventByID(ctx context.Context, in *FindEventByIDRequest, opts ...grpc.CallOption) (*FindEventByIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.v1.API/FindEventByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Check(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.v1.API/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Watch(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (API_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[0], "/proto.v1.API/Watch", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *aPIWatchClient) Recv() (*HealthCheckResponse, error) {
...
type APIServer interface {
	...
	Watch(*HealthCheckRequest, API_WatchServer) error
...
func (UnimplementedAPIServer) Watch(*HealthCheckRequest, API_WatchServer) error {
...
func _API_CreateEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.API/CreateEvent",
	}
...
func _API_UpdateEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.API/UpdateEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _API_DeleteEventByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.API/DeleteEventByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _API_FindEventByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.API/FindEventByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (x *aPIWatchServer) Send(m *HealthCheckResponse) error {
